...
namespace Cinemachine
{
    ...
    [SaveDuringPlay]
    public class CinemachineFramingTransposerv2 : CinemachineComponentBase
    {
        /// <summary>
        ...
        public bool m_CenterOnActivate = false;

        [Tooltip("Force center width")]
        public bool m_CenterWidth = false;
